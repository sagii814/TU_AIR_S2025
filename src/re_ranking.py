...
train_data = load_training_data(r'data\train_triples.json')
...
# Example usage:
create_train_triples_from_bioasq(r'data\training13b.json', r'results\bm25_predictions.json', r'data\train_triples.json')
create_inference_input_from_result(r'results\bm25_predictions.json', r'data\training13b.json', r'data\inference_input.json')
run_inference('bert_reranker_model', r'data\inference_input.json', r'results\rerank_predictions.json')
evaluate_reranker(r'results\rerank_predictions.json', r'data\training13b.json')
